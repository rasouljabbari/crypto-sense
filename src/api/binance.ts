...
const FUTURES_SYMBOLS = [
  ...
  "MKRUSDT", "RENDERUSDT", "FETUSDT", "ENAUSDT", "ONDOUSDT", "JUPUSDT", "PYTHUSDT",
  "THETAUSDT", "GRTUSDT", "SANDUSDT", "MANAUSDT", "AXSUSDT", "CHZUSDT", "FLOWUSDT", "EGLDUSDT", "ALGOUSDT",
  "HBARUSDT", "TONUSDT", "QNTUSDT", "XTZUSDT", "EOSUSDT", "NEOUSDT", "KAVAUSDT", "ZECUSDT", "IOTAUSDT",
  "COMPUSDT", "SNXUSDT", "1INCHUSDT", "DYDXUSDT", "LDOUSDT", "STRKUSDT", "CFXUSDT", "ROSEUSDT", "MEMEUSDT", "WIFUSDT",
  "RAYUSDT", "CAKEUSDT", "BEAMUSDT", "ORDIUSDT", "ETHFIUSDT", "PENDLEUSDT",
  "SUPERUSDT", "TWTUSDT", "WOOUSDT", "LRCUSDT", "BANDUSDT", "SFPUSDT",
...
export const KWN_NAMES: Record<string, string> = {
  ...
  JUP: "Jupiter", PYTH: "Pyth Network", THETA: "Theta Network", GRT: "The Graph", SAND: "The Sandbox",
  MANA: "Decentraland", AXS: "Axie Infinity", CHZ: "Chiliz", FLOW: "Flow",
  EGLD: "MultiversX", ALGO: "Algorand", KAS: "Kaspa", CRO: "Cronos",
  ...
  CORE: "Core DAO", WIF: "dogwifhat", RAY: "Raydium", AKT: "Akash Network",
  BEAM: "Beam", ORDI: "ORDI", ETHFI: "Ether.fi", PENDLE: "Pendle",
  SUPER: "SuperVerse", TWT: "Trust Wallet", WOO: "WOO Network", LRC: "Loopring", BAND: "Band Protocol",
  SFP: "SafePal", OCEAN: "Ocean Protocol", CELO: "Celo", ICX: "ICON",
