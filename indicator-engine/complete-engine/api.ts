...
const FUTURES_SYMBOLS = [
  ...
  "JUPUSDT", "PYTHUSDT", "THETAUSDT", "GRTUSDT",
  "SANDUSDT", "MANAUSDT", "AXSUSDT", "CHZUSDT", "FLOWUSDT", "EGLDUSDT", "ALGOUSDT",
  "HBARUSDT", "TONUSDT", "QNTUSDT", "XTZUSDT", "EOSUSDT", "NEOUSDT",
  "KAVAUSDT", "ZECUSDT", "IOTAUSDT", "COMPUSDT", "SNXUSDT", "1INCHUSDT", "DYDXUSDT",
  "LDOUSDT", "STRKUSDT", "CFXUSDT", "ROSEUSDT", "MEMEUSDT", "WIFUSDT",
  "RAYUSDT", "CAKEUSDT", "BEAMUSDT", "ORDIUSDT", "ETHFIUSDT", "PENDLEUSDT",
  "SUPERUSDT", "TWTUSDT", "WOOUSDT",
  "LRCUSDT", "BANDUSDT", "SFPUSDT", "OCEANUSDT", "CELOUSDT",
